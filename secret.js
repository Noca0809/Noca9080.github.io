...
const savedCategories = localStorage.getItem("secretcategories");
...
function renderLinks(filteredLinks = links) {
  ...
  filteredLinks.forEach((link, index) => {
    ...
    select.addEventListener("change", () => {
      ...
      localStorage.setItem("secretlinks", JSON.stringify(links));
      renderLinks();
    });
...
// 保存データ復元
const savedLinks = localStorage.getItem("secretlinks");
if (savedLinks) {
...
addCategoryBtn.addEventListener("click", () => {
  ...
  if (!categories.includes(newCat)) {
    ...
    localStorage.setItem("secretcategories", JSON.stringify(categories));
    renderLinks();
    renderCategoryList();
    renderFilter();
  }
